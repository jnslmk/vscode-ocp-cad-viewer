...
1. Open the VS Code Marketplace, and search and install _OCP CAD Viewer 3.0.6_.
...
-   Fix URL format for Python GHPkg publishing

### 3.0.5

**Fixes**

-   Fix GHPkg registry URL for Python package

### 3.0.4

**Fixes**

-   Use twine for GHPkg publishing
